...
(function (OWGS) {
    ...
    function newButton(text) {
        ...
        button.setAttribute("onclick", "OWGS.nextTest()");
    ...
    OWGS.hiddenAnswer = hiddenAnswer;
    function showAnswer() {
        // @ts-ignore
        $("#modal1-answer").css("visibility", "visible");
    }
    OWGS.showAnswer = showAnswer;
    function nextTest() {
        hiddenAnswer();
        // @ts-ignore
        $("#modal1-show").attr("onclick", "OWGS.showAnswer()");
        // @ts-ignore
        $("#modal1-next").attr("onclick", "OWGS.nextTest()");
    ...
    OWGS.nextTest = nextTest;
})(OWGS || (OWGS = {}));
// 使用以下命令生成gm_gs.js
// tsc ow_gs.ts --target "es5" --lib "es2015,dom" --downlevelIteration
